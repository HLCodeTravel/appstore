/* Top Secret */
package net.bat.store.widget.banner.adapter;
...
import net.bat.store.widget.banner.view.CBLoopViewPager;
...
public class CBPageAdapter<T> extends PagerAdapter {
    ...
    private Map<String, AdBean> mMapBeans;
    ...
    public CBPageAdapter(CBViewHolderCreator holderCreator, List<T> datas,Map<String, AdBean> map) {
    ...
    public View getView(int position, View view, ViewGroup container) {
        ...
        if (view == null) {
            ...
            view = holder.createView(container.getContext(),object,mMapBeans);
            view.setTag(R.id.cb_item_tag, holder);
        } else {
            holder = (Holder<T>) view.getTag(R.id.cb_item_tag);
        }
        if (mDatas != null && !mDatas.isEmpty())
            holder.UpdateUI(container.getContext(), position,mDatas.get(position),mMapBeans);
        return view;
    }
