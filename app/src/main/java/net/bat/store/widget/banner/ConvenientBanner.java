...
import net.bat.store.widget.banner.adapter.CBPageAdapter;
import net.bat.store.widget.banner.holder.CBViewHolderCreator;
import net.bat.store.widget.banner.listener.CBPageChangeListener;
...
public class ConvenientBanner<T> extends LinearLayout {
    ...
    public ConvenientBanner setPages(CBViewHolderCreator holderCreator, List<T> datas,Map<String, AdBean> map){
        this.mDatas = datas;
        pageAdapter = new CBPageAdapter(holderCreator,mDatas,map);
